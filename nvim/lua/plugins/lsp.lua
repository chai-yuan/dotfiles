return {
    ...
    config = function()
        ...
        vim.keymap.set('n', 'gd', "<cmd>lua require('telescope.builtin').lsp_definitions()<cr>", {desc = '[G]oto [D]efinition'})
        vim.keymap.set('n', 'gi', "<cmd>lua require('telescope.builtin').lsp_implementations()<cr>", {desc = '[G]oto [I]mplementation'})
